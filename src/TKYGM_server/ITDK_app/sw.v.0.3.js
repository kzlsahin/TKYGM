...
const PRECACHE_URLS = [
    BASEURL + '/',
    BASEURL + '/css/style.v.0.2.css',
    BASEURL + '/css/SurveyFormStyle.v.0.2.css',
    ...
    BASEURL + '/js/app.v.0.3.js',
    BASEURL + '/js/core.v.0.1.js',    
    BASEURL + '/js/components.v.0.3.js',
    BASEURL + '/js/SurveyForm.v.0.3.js',
